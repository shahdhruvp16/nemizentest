...
import { FaCode, FaChartLine, FaRobot, FaPalette, FaMobileAlt, FaServer, FaShoppingCart, FaSearch, FaUsers, FaDatabase, FaLaptopCode, FaBullhorn } from 'react-icons/fa';
        ...
        >
          ...
          >
            ...
            <div className="bg-gray-50 dark:bg-dark-deeper p-6">
              <button
                onClick={onClose}
                className="w-full py-3 px-6 bg-primary text-white rounded-lg font-medium hover:bg-primary-dark transition-colors duration-300"
              >
                Close
              </button>
            </div>
